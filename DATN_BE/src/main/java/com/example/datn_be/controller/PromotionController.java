...
public class PromotionController {
    ...
    public ResponseEntity<?> getPromotionById(@RequestBody Map<String, Integer> request) {
        try {
            ...
            PromotionsDTO promotion = promotionService.getPromotionById(promotionId);
            if (promotion != null) {
                return new ResponseEntity<>(
    ...
    // Xóa khuyến mãi
    @PostMapping("/remove")
    public ResponseEntity<Map<String, Object>> deletePromotion(@RequestParam("promotionId") Integer promotionId) {
        if (promotionId == null) {
