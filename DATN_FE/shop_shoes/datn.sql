...
CREATE TABLE `cart_items` (
  ...
  KEY `cartId` (`cartId`),
  CONSTRAINT `cart_items_ibfk_463` FOREIGN KEY (`productDetailId`) REFERENCES `product_details` (`productDetailId`) ON UPDATE CASCADE,
  CONSTRAINT `cart_items_ibfk_464` FOREIGN KEY (`cartId`) REFERENCES `shopping_carts` (`cartId`) ON UPDATE CASCADE
...
CREATE TABLE `conversations` (
  ...
  CONSTRAINT `conversations_ibfk_313` FOREIGN KEY (`senderId`) REFERENCES `users` (`userId`) ON UPDATE CASCADE,
  CONSTRAINT `conversations_ibfk_314` FOREIGN KEY (`receiverId`) REFERENCES `users` (`userId`) ON UPDATE CASCADE,
  CONSTRAINT `conversations_ibfk_315` FOREIGN KEY (`lastMessageId`) REFERENCES `messages` (`messagesId`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `messages` (
  ...
  CONSTRAINT `messages_ibfk_207` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON UPDATE CASCADE,
  CONSTRAINT `messages_ibfk_208` FOREIGN KEY (`conversationId`) REFERENCES `conversations` (`conversationId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_details` (
  ...
  CONSTRAINT `order_details_ibfk_201` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON UPDATE CASCADE,
  CONSTRAINT `order_details_ibfk_202` FOREIGN KEY (`voucherId`) REFERENCES `vouchers` (`voucherId`) ON UPDATE CASCADE
...
INSERT INTO `order_details` VALUES (17,1,'9ECBC5CE',1000,1861694536,'2024-09-09 11:48:20','2024-09-11 14:05:01','test bug 5/8','lbeephamthanhlong@gmail.com','0369232003',NULL,NULL,NULL,NULL,NULL),(18,2,'4F28528A',4000,1861694536,'2024-09-09 13:39:19','2024-09-13 22:43:50','test bug 5/8','lbeephamthanhlong@gmail.com','0369232003',5,NULL,NULL,NULL,NULL),(19,1,'F3583EB2',1000,1861694536,'2024-09-09 13:39:55','2024-09-09 14:16:31','test bug 5/8','lbeephamthanhlong@gmail.com','0369232003',5,NULL,NULL,NULL,NULL),(20,2,'60C4D7E3',2000,1861694536,'2024-09-09 13:40:34','2024-09-09 14:16:31','test bug 5/8','lbeephamthanhlong@gmail.com','0369232003',5,NULL,NULL,NULL,NULL),(21,1,'B509ECB2',1000,1861694536,'2024-09-09 13:40:59','2024-09-13 22:44:03','test bug 5/8','lbeephamthanhlong@gmail.com','0369232003',5,NULL,NULL,NULL,NULL),(22,1,'9AB2B05B',3000,1861694536,'2024-09-09 14:15:07','2024-09-09 14:15:07','test bug 5/8','lbeephamthanhlong@gmail.com','0369232003',NULL,NULL,NULL,NULL,NULL),(23,1,'5C052D91',1000,1861694536,'2024-09-09 14:18:12','2024-09-09 14:18:12','test bug 5/8','lbeephamthanhlong@gmail.com','0369232003',NULL,NULL,NULL,NULL,NULL),(24,1,'CA60C18E',3000,1861694536,'2024-09-09 14:20:10','2024-09-09 14:20:10','test bug 5/8','lbeephamthanhlong@gmail.com','0369232003',NULL,NULL,NULL,NULL,NULL),(25,1,'EBC4D95A',3000,1861694536,'2024-09-09 14:20:32','2024-09-09 14:21:54','test bug 5/8','lbeephamthanhlong@gmail.com','0369232003',5,NULL,NULL,NULL,NULL),(26,1,'0970B23D',3500,1861694536,'2024-09-09 14:20:55','2024-09-09 14:20:55','test bug 5/8','Giao Nhân Giao Thủy Nam Định','0369232003',5,NULL,NULL,NULL,NULL),(27,2,'B718CD63',2000,1861694536,'2024-09-09 20:38:02','2024-09-09 20:38:02','test bug 5/8','Giao Nhân Giao Thủy Nam Định','0369232003',NULL,NULL,NULL,NULL,NULL),(28,1,'BF2438F7',1000,1861694536,'2024-09-09 20:40:47','2024-09-09 20:40:47','test bug 5/8','Giao Nhân Giao Thủy Nam Định','0369232003',NULL,NULL,NULL,NULL,NULL),(29,1,'A6846DE9',1000,1861694536,'2024-09-09 20:42:12','2024-09-09 20:42:12','test bug 5/8','Giao Nhân Giao Thủy Nam Định','0369232003',NULL,NULL,NULL,NULL,NULL),(30,1,'C9F0D685',1000,1861694536,'2024-09-09 20:42:30','2024-09-09 20:42:30','test bug 5/8','Giao Nhân Giao Thủy Nam Định','0369232003',NULL,NULL,NULL,NULL,NULL),(31,2,'20953A9B',2000,1861694536,'2024-09-11 14:02:39','2024-09-11 14:04:57','test bug 5/8','Giao Nhân Giao Thủy Nam Định','0369232003',5,NULL,NULL,NULL,NULL),(32,2,'D8C826D2',2000,1861694536,'2024-09-11 14:09:57','2024-09-11 14:09:57','test bug 5/8','Giao Nhân Giao Thủy Nam Định','0369232003',NULL,NULL,NULL,NULL,NULL),(33,2,'22C82762',4000,1861694536,'2024-09-11 14:10:15','2024-09-13 22:43:50','test bug 5/8','Giao Nhân Giao Thủy Nam Định','0369232003',5,NULL,NULL,NULL,NULL),(34,1,'ABEBE8AE',1000,1861694536,'2024-09-13 22:44:26','2024-09-13 22:44:26','test bug 5/8','Giao Nhân Giao Thủy Nam Định','0369232003',NULL,NULL,NULL,NULL,0),(35,1,'84923054',2000,1861694536,'2024-09-13 22:45:34','2024-09-13 22:45:34','test bug 5/8','Giao Nhân Giao Thủy Nam Định','0369232003',NULL,NULL,NULL,NULL,0);
...
CREATE TABLE `order_items` (
  ...
  CONSTRAINT `order_items_ibfk_455` FOREIGN KEY (`productDetailId`) REFERENCES `product_details` (`productDetailId`) ON UPDATE CASCADE,
  CONSTRAINT `order_items_ibfk_456` FOREIGN KEY (`orderDetailId`) REFERENCES `order_details` (`orderDetailId`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `order_items` VALUES (15,1,12,17,'2024-09-09 11:48:20','2024-09-11 14:06:02',1000,'CHO_LAY_HANG',1861694536,1000,1000,0,NULL),(16,1,35,18,'2024-09-09 13:39:19','2024-09-13 22:46:33',2000,'CHO_GIAO_HANG',1861694536,2000,2000,0,NULL),(17,1,36,18,'2024-09-09 13:39:19','2024-09-13 22:46:33',2000,'CHO_THANH_TOAN',1861694536,2000,2000,0,NULL),(18,1,12,19,'2024-09-09 13:39:55','2024-09-13 22:46:33',1000,'CHO_THANH_TOAN',1861694536,1000,1000,0,NULL),(19,1,12,20,'2024-09-09 13:40:34','2024-09-13 22:46:33',1000,'CHO_THANH_TOAN',1861694536,1000,1000,0,NULL),(20,1,13,20,'2024-09-09 13:40:34','2024-09-13 22:46:33',1000,'CHO_THANH_TOAN',1861694536,1000,1000,0,NULL),(21,1,12,21,'2024-09-09 13:40:59','2024-09-13 22:46:33',1000,'CHO_THANH_TOAN',1861694536,1000,1000,0,NULL),(22,1,42,22,'2024-09-09 14:15:07','2024-09-13 22:46:33',3000,'DA_GIAO',1861694536,3000,3000,0,NULL),(23,1,13,23,'2024-09-09 14:18:12','2024-09-10 20:34:34',1000,'DA_GIAO',1861694536,1000,1000,0,NULL),(24,1,42,24,'2024-09-09 14:20:10','2024-09-13 22:46:33',3000,'CHO_GIAO_HANG',1861694536,3000,3000,0,NULL),(25,1,42,25,'2024-09-09 14:20:32','2024-09-13 22:46:33',3000,'CHO_LAY_HANG',1861694536,3000,3000,0,NULL),(26,1,47,26,'2024-09-09 14:20:55','2024-09-09 14:21:15',4500,'CHO_LAY_HANG',1861694536,4500,4500,0,NULL),(27,2,12,27,'2024-09-09 20:38:02','2024-09-13 22:46:33',2000,'CHO_GIAO_HANG',1861694536,1000,1000,0,NULL),(28,1,12,28,'2024-09-09 20:40:47','2024-09-09 20:41:49',1000,'CHO_LAY_HANG',1861694536,1000,1000,0,NULL),(29,1,12,29,'2024-09-09 20:42:12','2024-09-13 22:46:33',1000,'CHO_LAY_HANG',1861694536,1000,1000,0,NULL),(30,1,12,30,'2024-09-09 20:42:30','2024-09-13 22:46:33',1000,'CHO_LAY_HANG',1861694536,1000,1000,0,NULL),(31,1,12,31,'2024-09-11 14:02:39','2024-09-13 22:46:33',1000,'CHO_THANH_TOAN',1861694536,1000,1000,0,NULL),(32,1,13,31,'2024-09-11 14:02:39','2024-09-13 22:46:33',1000,'CHO_THANH_TOAN',1861694536,1000,1000,0,NULL),(33,1,12,32,'2024-09-11 14:09:57','2024-09-13 22:46:33',1000,'CHO_THANH_TOAN',1861694536,1000,1000,0,NULL),(34,1,13,32,'2024-09-11 14:09:57','2024-09-13 22:46:33',1000,'CHO_THANH_TOAN',1861694536,1000,1000,0,NULL),(35,1,35,33,'2024-09-11 14:10:15','2024-09-13 22:46:33',2000,'CHO_THANH_TOAN',1861694536,2000,2000,0,NULL),(36,1,36,33,'2024-09-11 14:10:15','2024-09-13 22:46:33',2000,'CHO_THANH_TOAN',1861694536,2000,2000,0,NULL),(37,1,12,34,'2024-09-13 22:44:26','2024-09-13 22:46:33',1000,'CHO_THANH_TOAN',1861694536,1000,1000,0,NULL),(38,1,35,35,'2024-09-13 22:45:34','2024-09-13 22:46:33',2000,'CHO_XAC_NHAN',1861694536,2000,2000,0,NULL);
...
INSERT INTO `payment_details` VALUES (1,17,'SUCCESS',1000,'MOMO','2024-09-09 11:48:20','2024-09-11 14:06:02'),(2,18,'IDLE',4000,'MOMO','2024-09-09 13:39:19','2024-09-13 22:43:50'),(3,19,'IDLE',1000,'MOMO','2024-09-09 13:39:55','2024-09-09 14:16:31'),(4,20,'IDLE',2000,'MOMO','2024-09-09 13:40:34','2024-09-09 14:16:31'),(5,21,'IDLE',1000,'MOMO','2024-09-09 13:40:59','2024-09-09 14:16:31'),(6,22,'CASH',3000,'CASH','2024-09-09 14:15:07','2024-09-09 14:15:07'),(7,23,'SUCCESS',1000,'MOMO','2024-09-09 14:18:12','2024-09-09 14:19:02'),(8,24,'CASH',3000,'CASH','2024-09-09 14:20:10','2024-09-09 14:20:10'),(9,25,'CASH',3000,'CASH','2024-09-09 14:20:32','2024-09-09 14:21:54'),(10,26,'SUCCESS',3500,'MOMO','2024-09-09 14:20:55','2024-09-09 14:21:15'),(11,27,'CASH',2000,'CASH','2024-09-09 20:38:02','2024-09-09 20:38:02'),(12,28,'SUCCESS',1000,'MOMO','2024-09-09 20:40:47','2024-09-09 20:41:49'),(13,29,'CASH',1000,'CASH','2024-09-09 20:42:12','2024-09-09 20:42:12'),(14,30,'CASH',1000,'CASH','2024-09-09 20:42:30','2024-09-09 20:42:30'),(15,31,'IDLE',2000,'MOMO','2024-09-11 14:02:39','2024-09-11 14:04:57'),(16,32,'IDLE',2000,'MOMO','2024-09-11 14:09:57','2024-09-11 14:09:57'),(17,33,'IDLE',4000,'MOMO','2024-09-11 14:10:15','2024-09-13 22:43:50'),(18,34,'IDLE',1000,'MOMO','2024-09-13 22:44:26','2024-09-13 22:44:26'),(19,35,'CASH',2000,'CASH','2024-09-13 22:45:34','2024-09-13 22:45:34');
...
CREATE TABLE `product_details` (
  ...
  KEY `sizeId` (`sizeId`),
  KEY `productId` (`productId`),
  CONSTRAINT `product_details_ibfk_451` FOREIGN KEY (`sizeId`) REFERENCES `sizes` (`sizeId`) ON UPDATE CASCADE,
  CONSTRAINT `product_details_ibfk_452` FOREIGN KEY (`productId`) REFERENCES `products` (`productId`) ON UPDATE CASCADE
...
CREATE TABLE `products` (
  ...
  KEY `brandId` (`brandId`),
  CONSTRAINT `products_ibfk_901` FOREIGN KEY (`originId`) REFERENCES `origins` (`originId`) ON UPDATE CASCADE,
  CONSTRAINT `products_ibfk_902` FOREIGN KEY (`styleId`) REFERENCES `styles` (`styleId`) ON UPDATE CASCADE,
  CONSTRAINT `products_ibfk_903` FOREIGN KEY (`materialId`) REFERENCES `materials` (`materialId`) ON UPDATE CASCADE,
  CONSTRAINT `products_ibfk_904` FOREIGN KEY (`brandId`) REFERENCES `brands` (`brandId`) ON UPDATE CASCADE
...
INSERT INTO `promotions` VALUES (6,'2024-09-09 00:00:00','2024-09-10 00:00:00','2024-09-09 09:04:48','2024-09-13 00:00:00',1000.00,'EXPIRED',111141),(7,'2024-09-09 00:00:00','2024-09-09 00:00:00','2024-09-09 09:11:22','2024-09-09 11:46:00',10000.00,'EXPIRED',108523);
...
CREATE TABLE `user_vouchers` (
  ...
  CONSTRAINT `user_vouchers_ibfk_191` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_vouchers_ibfk_192` FOREIGN KEY (`voucherId`) REFERENCES `vouchers` (`voucherId`) ON UPDATE CASCADE
...
INSERT INTO `users` VALUES (1160752695,'admin','admin111@gmail.com1','0369232003','$2b$10$FU/RW8RcwLg3j.w11HFn7.mSDxyDMpiXCUYVmBU9p.aHwB7k67uAW','2024-09-13','LAM_VIEC',3,'2024-07-26 14:36:29','2024-09-13 21:40:16',NULL),(1289640823,'long','huongtmph41872@fpt.edu.vn','0358091695','$2b$10$t2Uy3l2uh9akjUnH6KT10uYgYoVAFLkj1NmYNsxP39OmOvmyPc5eW',NULL,'Phạm Thành Long',1,'2024-08-08 13:52:50','2024-08-08 13:52:50',NULL),(1861694536,'tuyen','tuyen@dev.dev','0358091695','$2b$10$ov7ihlGV1MvFpkSbaD4Xf.YWZ5weL3NF9xtI6Jorwmsw7YsZAL1pq',NULL,'PHAM NGOC TUYEN',1,'2024-08-06 19:15:47','2024-08-06 19:15:47',NULL);
...
INSERT INTO `vouchers` VALUES (5,'VOUCHER001','adfasdfa',1000.00,1000.00,'2024-09-09 10:12:24','2024-09-09 23:00:00',991,'ISACTIVE','MONEY','MIN_ORDER_VALUE',1000.00,NULL,NULL,'2024-09-09 10:12:34','2024-09-11 14:10:15',1000.00);
...
-- Dump completed on 2024-09-13 23:00:30
